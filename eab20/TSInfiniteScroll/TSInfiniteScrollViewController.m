...
// grid properties
#define TSNumberOfShownRows    6
#define TSNumberOfShownCols    4
#define TSNumberOfRowsPerPage  6

// some metrics
#define OFFSET_NO_ROWS CGSizeMake(30, 60)
#define MARGIN_LEFT_NO_ROWS 10
#define MARGIN_RIGHT_NO_ROWS 10
#define MARGIN_TOP_NO_ROWS 10
#define MARGIN_BOTTOM_NO_ROWS 10
#define ITEM_BOUNDS CGRectMake(0, 0 ,64, 64)
...
- (void)viewDidLoad {
    gridView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, 320, 2 * (ITEM_BOUNDS.size.height + MARGIN_TOP_NO_ROWS + MARGIN_BOTTOM_NO_ROWS))];
